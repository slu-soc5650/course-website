...
[^3]: USB 3.0 drives tend to be faster than their older counterparts. You can tell that a drive is produced using the 3.0 standard by looking at the plug portion of the thumb drive or cable, which will often be colored blue. You can see that coloring in the product image for [USB cable](https://www.amazon.com/AmazonBasics-USB-3-0-Cable-Male/dp/B00NH13G5A/). If the plug is white or black, it is typically a USB 2.0 device. [The picture](https://www.amazon.com/AmazonBasics-USB-3-0-Cable-Male/dp/B00NH13G5A/) also illustrates the other giveaway for USB 3.0 devices, many of which use a similar cable that uses a distinctive Micro-B male connector (on the right side of the photo).