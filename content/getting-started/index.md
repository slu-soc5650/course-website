...
* Read through the [**Syllabus**](https://github.com/slu-soc5650/Core-Documents/blob/master/syllabus.pdf) and the [**Reading List**](https://github.com/slu-soc5650/Core-Documents/blob/master/reading-list.pdf)
* [Account signups](/getting-started/#account-signups):
  * Slack
  * GitHub
* If you are using your own computer (skip if you'll only use the lab computers), [get it ready for the semester](/getting-started/#get-started-with-software):
  ...
  * Decide if you can and want to run ArcGIS
* [Purchase books](/getting-started/#get-access-to-books)
* [Download course data](/getting-started/#get-access-to-course-data):
  * Ensure you have a thumb drive or external drive that meets spec for the course, or purchase one if you do not
  * Download and extract the course data release to your external device
...
Additionally, you'll want to make sure you have the Microsoft Office suite installed on your computer. If you are a Windows user without Microsoft Office, you can purchase it through [Microsoft's education program](http://www.onthehub.com/microsoft-windows-10-education-for-students/?utm_source=ms-student-page&utm_medium=microsoft-site&utm_campaign=windows10) for $9.95. If you are a macOS user, you can either use Apple's iWork productivity suite (available for free in the App Store) or you can purcahse Office for Mac through [Microsoft's education program](http://www.onthehub.com/microsoft-windows-10-education-for-students/?utm_source=ms-student-page&utm_medium=microsoft-site&utm_campaign=windows10) for $9.95. 
...
## Get Access to Course Data
To ensure that you have access to your files throughout the semester, you will need an external storage device (a USB thumb drive or an external hard drive) for this course. You will need to purchase one if you do not already own one that meets the key specifications: (1) the device meets the USB 3.0 standard[^3] and (2) it has at least 20 GB of free space. Thumb drives meeting these specifications begin at about $10 and go up from there. External hard drives, which are considerably larger, start at about $60 and increase in cost from there.

Mac users will likely have to [reformat their drive](https://support.apple.com/kb/PH22241?locale=en_US) so that it is accessible both to their macOS device and the Windows computers in the lab (and, additionally, a Windows partition on your Mac if you choose to install one). You **must** choose either MS-DOS (FAT-32) or ExFAT for your drive's file system. You can read more about both options [here](https://www.howtogeek.com/235596/whats-the-difference-between-fat32-exfat-and-ntfs/), but I recommend using ExFAT.

Once you have a drive, you will want to download the course data release. The link to the data is available on Slack in the `#_news` channel. Depending on your internet connection, it may take a bit of time. The data will come as a `.zip` archive that you will need to extract the files from (here are links for [Windows](https://support.microsoft.com/en-us/help/14200/windows-compress-uncompress-zip-files) and [macOS](https://support.apple.com/kb/PH25411?locale=en_US) instructions). Move the **extracted** file system onto your external drive. For a description of the course file system that comes with the data release, see the [Creating a Sustainable File System](https://chris-prener.github.io/SSDSBook/creating-a-sustainable-file-system.html) section in Chris's [Sociospatial Data Science](https://chris-prener.github.io/SSDSBook/) book.

{{< warning title="Data Release" >}}
The data release is planned for January 12th. If you have your external drive obtained beforehand, hang tight! If you don't have it by then, don't worry, you'll be able to download the data whenever you are ready.
{{< /warning >}}
...
[^3]: USB 3.0 drives tend to be faster than their older counterparts. You can tell that a drive is produced using the 3.0 standard by looking at the plug portion of the thumb drive or cable, which will often be colored blue. You can see that coloring in the product image for an example [USB cable](https://www.amazon.com/AmazonBasics-USB-3-0-Cable-Male/dp/B00NH13G5A/). If the plug is white or black, it is typically a USB 2.0 device. [The same picture](https://www.amazon.com/AmazonBasics-USB-3-0-Cable-Male/dp/B00NH13G5A/) also illustrates the other giveaway for USB 3.0 devices, many of which use a similar cable that uses a distinctive Micro-B male connector (on the right side of the photo).